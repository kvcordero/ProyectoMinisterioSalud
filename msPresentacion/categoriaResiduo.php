...
<html lang="es-es" dir="ltr"  data-config='{"twitter":0,"plusone":0,"facebook":0,"style":"ms"}'>
    ...
    <body>
        ...
        <div class="sideBar">
            ...
            <ul>
                <li><span onclick="showRegisterSection()">Crear Categoria Residuo</span></li>
                <li><span onclick="showActualizeSection()">Actualizar Categoria Residuo</span></li>
                <li><span onclick="showDeleteSection()">Eliminar Categoria Residuo</span></li>
            </ul>
        </div>
                 ...
                 <div class="formContent">
                     <div class="form">
                         <form id="userForm" class="formoid-solid-blue" method="post">
                             <div class="title"><h2>Registrar Categoria Residuo</h2></div>
                             <div class="element-input"><div class="item-cont"><input class="large" type="text" id="txtCategoriaResiduo" placeholder="Categoria Residuo"/><span class="icon-place"></span></div></div>
                 ...
                 <div class="formContent">
                     <div class="form">
                         ...
                         <form id="userForm" class="formoid-solid-blue" method="post">
                             ...
                             <div class="element-separator"><hr></hr><h3 class="section-break-title">Buscar Categoria</h3></div>
                             <div class="element-input"><div class="item-cont"><input class="large" type="text" id="txtIdentificacion" placeholder="Nueva Categoria Residuo"/><span class="icon-place"></span></div></div>
