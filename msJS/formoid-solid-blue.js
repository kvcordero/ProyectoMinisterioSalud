...
!function (c) {
    ...
    var b = {modes: [{clsName: "days", navFnc: "Month", navStep: 1}, {clsName: "months", navFnc: "FullYear", navStep: 1}, {clsName: "years", navFnc: "FullYear", navStep: 10}], dates: {days: ["Domingo", "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "Sabado", "Domingo"], daysShort: ["Dom", "Lun", "Mar", "Mie", "Jue", "Vie", "Sab", "Dom"], daysMin: ["Do", "Lu", "Ma", "Mi", "Ju", "Vi", "Sa", "Do"], months: ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"], monthsShort: ["Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dic"]}, isLeapYear: function (d) {
...
jQuery(".formoid-solid-blue").find('input[type=date]').each(function () {
    var date = $(this);
...
jQuery(function () {
    ...
    form.validate({errorClass: "error-label", wrapper: "label", errorElement: "span", ignore: "", success: function (b, c) {
            if (b.parent().hasClass("tooltip")) {
                b.parent().remove()
            } else {
                b.remove()
            }
            var d = a(c).parent();
            d.removeClass("error-field")
        }, errorPlacement: function (b, c) {
            var d = a(c).parent();
            d.addClass("error-field");
            b.css("marginLeft", 0).appendTo(d || c).addClass("tooltip").addClass("bottom").addClass("error").append(a("<span>").addClass("tooltip-arrow"))
        }});
